    ...
    public class NodeSetupTests
    {
        ...
        public void FundMainChain()
        {
            using (SidechainTestContext context = new SidechainTestContext())
            {
                ...
                TestHelper.WaitForNodeToSync(context.MainUser, context.FedMain1, context.FedMain2);
        ...
        public void FundSideChain()
        {
            using (SidechainTestContext context = new SidechainTestContext())
            {
                ...
                TestHelper.WaitForNodeToSync(context.SideUser, context.FedSide1, context.FedSide2);
