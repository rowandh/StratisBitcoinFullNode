    ...
    public sealed class SmartContractMinerTests
    {
        ...
        public class TestContext
        {
            ...
            public async Task InitializeAsync([CallerMemberName] string callingMethod = "")
            {
                ...
                this.executorFactory = new ReflectionSmartContractExecutorFactory(loggerFactory, this.contractPrimitiveSerializer, this.serializer, this.refundProcessor, this.transferProcessor, this.vm, this.network);
